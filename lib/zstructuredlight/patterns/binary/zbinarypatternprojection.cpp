    ...
    , m_previewEnabled(false)
{
    ...
    QObject::connect(qGuiApp, &QGuiApplication::screenAdded,
                     this, &ZBinaryPatternProjection::updateScreens);
    ...
    ZSettingsItemPtr screenOption = std::unique_ptr<ZSettingsItemEnum>(new ZSettingsItemEnum(projectorScreen, "Projector", "Screen/projector to use",
                                                                                             [=](){
...
//    QObject::connect(this, &ZBinaryPatternProjection::Changed,
//                     screenOption.get(), &ZSettingsItem::valueChanged);
...
void ZBinaryPatternProjection::updateScreens()
{
